...
export const Navbar = () => {
  ...
  return (
    <nav className='fixed w-full z-[90]'>
      ...
      <aside className={`${isMenuOpen ? 'left-0' : '-left-full'} z-[90] md:left-0 bg-white md:bg-white/90 backdrop-blur-md px-8 transition-all duration-300 fixed h-screen border-r border-[#e5e5e5] flex flex-col gap-5 pt-4 items-center md:w-[16%]`}>
